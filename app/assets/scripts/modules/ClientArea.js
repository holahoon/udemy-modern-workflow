...
class ClientArea {
  constructor() {
    ...
    this.inputField = document.querySelector(".client-area__input");
  ...
  sendRequest() {
    Axios.post(
      "https://agitated-jones-5fb44e.netlify.com/.netlify/functions/secret-area",
      { password: this.inputField.value }
    )
      .then(res => {
        this.form.remove();
